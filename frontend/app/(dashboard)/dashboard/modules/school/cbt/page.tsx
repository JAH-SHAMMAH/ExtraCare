...
export default function CBTPage() {
  // Admin/teacher-only CBT management. Students use the dedicated
  // /dashboard/my-exams route (gated via roleOnly in CORE_NAV, independent of
  // the /cbt permission tree). This page requires school:cbt:read.
  return <TeacherCBTView />;
}

// ── Teacher/Admin view (original) ──

function TeacherCBTView() {
