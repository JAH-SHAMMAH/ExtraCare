...
import {
  ...
  Calendar, ClipboardList, MessageSquareText, ClipboardCheck, Users2, BookOpen, Bell, Shield, ShieldCheck,
...
const CORE_NAV = [
  ...
  { href: "/dashboard/my-exams", label: "My Exams", icon: MonitorCheck, roleOnly: "student" as ActiveRole },
  { href: "/dashboard/my-live-classes", label: "My Live Classes", icon: Radio, roleOnly: "student" as ActiveRole },
  ...
  { href: "/dashboard/hrm/attendance/my", label: "My Attendance", icon: Fingerprint },
